...
if __name__ == '__main__':
  ...
  # if 'sock_connection' not in session and not session['sock_connection']:
  #   session['sock_connection'] = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
  #   session['sock_connection'].bind(("192.168.1.54", 1337))
